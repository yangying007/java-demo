...
public class UserServiceImpl implements UserService {
    ...
    private void saveAndSendMsg(User user) {
        ...
        rabbitTemplate.convertAndSend(DirectRabbitConfig.LOGIN_LOG_EXCHANGE_NAME, DirectRabbitConfig.LOGIN_LOG_ROUTING_KEY_NAME, MessageHelper.objToMsg(loginLog), correlationData);

        MsgLog msgLog = new MsgLog(msgId, loginLog, DirectRabbitConfig.LOGIN_LOG_EXCHANGE_NAME, DirectRabbitConfig.LOGIN_LOG_ROUTING_KEY_NAME);
